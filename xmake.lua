...
do
    ...
    add_includedirs(
        "drivers/apm32f1/cmsis/Include",
        "drivers/apm32f1/hal/Inc",
        "drivers/apm32f1/cmsis_core/Include",
        {public = true}
    )
    ...
    add_installfiles(
        "drivers/apm32f1/cmsis/Include/*.h",
        "drivers/apm32f1/hal/Inc/*.h",
        "drivers/apm32f1/cmsis_core/Include/*.h",
            ...
            if project.option("use_default_startup"):value() then
                ...
                if string.find(mcu, "APM32F103ZE") then
                    if target:has_tool("cc", "gcc") then
                        target:add(
                            "files",
                            "$(scriptdir)/drivers/apm32f1/cmsis/Source/Templates/gcc/startup_stm32f103xe.s"
                        )
                    end
                end
            end
