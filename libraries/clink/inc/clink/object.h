 ...
 * @param type is the type of object, which can be CLINK_Object_Class_Device/... etc
...
/**
 * @brief This function will copy the object pointer of the specified type, with the maximum size specified by maxlen.
 * @param type is the type of object, which can be CLINK_Object_Class_Device/... etc
...
/**
 * @brief This function will detach a static object from object system, and the memory of static object is not freed.
...
/**
 * @brief This function will initialize an object and add it to object system management.
...
/**
 * @brief This function will find specified name object from object container.
 * @param name is the specified name of object.
 * @param type is the type of object
 * @return the found object or CLINK_NULL if there is no this object in object container.
